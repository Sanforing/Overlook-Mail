...
const LOCALES = {
  en: {
    ...
    cancel:              'Cancel',
    noticeFreeTier:      'Paste text below or upload a .txt / .epub file.',
  ...
  cht: {
    ...
    sendInbox:           '傳送至我的收件匣',
    cancel:              '取消',
    noticeFreeTier:      '在下方貼上文字，或上傳 .txt / .epub 檔案。',
  ...
  ja: {
    ...
    cancel:              'キャンセル',
    noticeFreeTier:      '下にテキストを貼り付けるか、.txt / .epub ファイルをアップロードしてください。',
