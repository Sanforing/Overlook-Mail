...
const LOCALES = {
  en: {
    ...
    fieldDriveUrl:         'Or paste a Google Drive share link (.txt / .epub)',
    noticeDriveNovel:       'We’ll use your Google account to download the file securely to this browser. Private Drive files work too — no bytes touch our server.',
    fieldDriveUrlRom:       'Or paste a Google Drive ROM link',
    noticeDriveRom:         'Paste a Google Drive link to your ROM. We’ll download it to this browser using your Google account. Private files work. No bytes touch our server.',
  ...
  cht: {
    ...
    fieldDriveUrl:         '或貼上 Google Drive 分享連結（.txt／.epub）',
    noticeDriveNovel:      '我們會透過你的 Google 帳號將檔案安全下載至這個瀏覽器。私有 Drive 檔案也支持，不會上傳到我們伺服器。',
    fieldDriveUrlRom:      '或貼上 Google Drive ROM 連結',
    noticeDriveRom:        '貼上你 ROM 的 Google Drive 連結，我們會透過你的 Google 帳號將其下載至這個瀏覽器。私有檔案也支持，不會上傳到伺服器。',
  ...
  ja: {
    ...
    fieldDriveUrl:         'または Google Drive 共有リンク（.txt / .epub）を貼り付け',
    noticeDriveNovel:      'Google アカウントを使ってファイルをこのブラウザーに安全にダウンロードします。非公開の Drive ファイルも対応。サーバーには一切送信しません。',
    fieldDriveUrlRom:      'または Google Drive の ROM リンクを貼り付け',
    noticeDriveRom:        'ROM の Google Drive リンクを貼り付けてください。Google アカウントでこのブラウザーにダウンロードします。非公開ファイルも対応。サーバーには送信しません。',
