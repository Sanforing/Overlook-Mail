...
const LOCALES = {
  en: {
    ...
    upgradeAlreadyPaid:  'Your account is already upgraded.',
    upgradeModalTitle:   'Support Overlook Mail',
    upgradeModalKicker:  'One-time donation',
    upgradeModalLead:    'A US$2 donation upgrades your account and helps us keep building a quieter, better inbox for games and reading.',
    upgradeBenefitNoAds: 'Hide in-site sponsored messages while signed in.',
    upgradeBenefitUploads: 'Keep access to private upload features for novels and ROMs.',
    upgradeBenefitSupport: 'Support hosting, maintenance, and new stealth-reading features.',
    upgradeModalHelp:    'This is not a monthly subscription. It is a small one-time thank-you that keeps development moving.',
    upgradeModalPay:     'Donate US$2',
    upgradeModalLater:   'Maybe later',
    ...
    fieldDriveUrl:         'Or paste a public Google Drive link (.txt / .epub)',
    noticeDriveNovel:       'Paste a public Drive link to make visibility selectable, or pick a private Drive file to cache it in this browser. No bytes touch our server.',
    btnPickDrive:          'Pick from Drive',
    pickedDriveFile:       'Picked Drive file',
    visibilityPrivateLocked: 'Visibility is locked to private because this file is stored only in this browser.',
    fieldDriveUrlRom:       'Or paste a public Google Drive ROM link',
    noticeDriveRom:         'Paste a public Drive ROM link to make visibility selectable, or pick a private Drive ROM to cache it in this browser. No bytes touch our server.',
    errBadDriveUrl:         'That doesn’t look like a Google Drive share link.',
    errNoDriveConfig:       'Google Drive is not configured on this server. Please upload the file directly.',
    statusDriveDownloading: 'Downloading from Google Drive…',
    btnDriveRedownload:     'Re-download from Google Drive',
    ...
    cancel:              'Cancel',
    noticeFreeTier:      'Paste text below or choose a .txt / .epub file. Content stays in this browser.',
    ...
    noticeRomLegal:      'You are responsible for the legality of any ROM you choose. ROM content stays in this browser.',
  ...
  cht: {
    ...
    upgradeAlreadyPaid:  '你的帳戶已經完成升級。',
    upgradeModalTitle:   '支持 Overlook Mail',
    upgradeModalKicker:  '一次性捐助',
    upgradeModalLead:    '捐助 US$2 即可升級帳戶，同時幫助我們繼續開發更安靜、更好用的遊戲與閱讀收件箱。',
    upgradeBenefitNoAds: '登入後隱藏站內贊助訊息。',
    upgradeBenefitUploads: '保留小說與 ROM 私人上傳功能。',
    upgradeBenefitSupport: '支持主機、維護與新的隱密閱讀功能開發。',
    upgradeModalHelp:    '這不是月費訂閱，而是一筆小額一次性支持，幫助我們持續開發。',
    upgradeModalPay:     '捐助 US$2',
    upgradeModalLater:   '稍後再說',
    personalise:         '個人化…',
    signOut:             '登出',
    ...
    fieldDriveUrl:         '或貼上公開 Google Drive 連結（.txt／.epub）',
    noticeDriveNovel:      '貼上公開 Drive 連結時可自行選擇可見性；或從 Drive 選取私有檔案並快取到此瀏覽器。不會上傳到我們伺服器。',
    btnPickDrive:          '從 Drive 選取',
    pickedDriveFile:       '已選取 Drive 檔案',
    visibilityPrivateLocked: '此檔案只儲存在此瀏覽器，因此可見性已鎖定為私人。',
    fieldDriveUrlRom:      '或貼上公開 Google Drive ROM 連結',
    noticeDriveRom:        '貼上公開 Drive ROM 連結時可自行選擇可見性；或從 Drive 選取私有 ROM 並快取到此瀏覽器。不會上傳到伺服器。',
    errBadDriveUrl:        '此連結看起來不是 Google Drive 分享連結。',
    errNoDriveConfig:      '此伺服器未設定 Google Drive，請直接上傳檔案。',
    statusDriveDownloading: '正在從 Google Drive 下載…',
    btnDriveRedownload:    '從 Google Drive 重新下載',
    fieldSubject:        '主旨',
    camoLabel:           '偽裝主旨',
  ...
  ja: {
    ...
    upgradeAlreadyPaid:  'アカウントはすでにアップグレード済みです。',
    upgradeModalTitle:   'Overlook Mail を支援する',
    upgradeModalKicker:  '一回限りの寄付',
    upgradeModalLead:    'US$2 の寄付でアカウントをアップグレードし、ゲームと読書のための静かな受信箱づくりを支援できます。',
    upgradeBenefitNoAds: 'サインイン中のサイト内スポンサーメッセージを非表示にします。',
    upgradeBenefitUploads: '小説と ROM のプライベートアップロード機能を利用できます。',
    upgradeBenefitSupport: 'ホスティング、保守、新しいステルス読書機能の開発を支援します。',
    upgradeModalHelp:    '月額サブスクリプションではありません。開発を続けるための小さな一回限りの支援です。',
    upgradeModalPay:     'US$2 を寄付',
    upgradeModalLater:   'あとで',
    personalise:         'カスタマイズ…',
    signOut:             'サインアウト',
    ...
    fieldDriveUrl:         'または公開 Google Drive リンク（.txt / .epub）を貼り付け',
    noticeDriveNovel:      '公開 Drive リンクを貼り付けた場合は公開範囲を選べます。非公開 Drive ファイルは「Drive から選択」でこのブラウザーに保存できます。サーバーには送信しません。',
    btnPickDrive:          'Drive から選択',
    pickedDriveFile:       '選択した Drive ファイル',
    visibilityPrivateLocked: 'このファイルはこのブラウザーだけに保存されるため、公開範囲は非公開に固定されます。',
    fieldDriveUrlRom:      'または公開 Google Drive ROM リンクを貼り付け',
    noticeDriveRom:        '公開 Drive ROM リンクを貼り付けた場合は公開範囲を選べます。非公開 ROM は「Drive から選択」でこのブラウザーに保存できます。サーバーには送信しません。',
    errBadDriveUrl:        'Google Drive の共有リンクではないようです。',
    errNoDriveConfig:      'このサーバーには Google Drive が設定されていません。ファイルを直接アップロードしてください。',
    statusDriveDownloading: 'Google Drive からダウンロード中…',
    btnDriveRedownload:    'Google Drive から再ダウンロード',
    fieldSubject:        '件名',
    camoLabel:           '件名を偽装',
    ...
    cancel:              'キャンセル',
    noticeFreeTier:      '下にテキストを貼り付けるか、.txt / .epub ファイルを選択してください。内容はこのブラウザー内に保存されます。',
    ...
    noticeRomLegal:      '選択する ROM の合法性はあなたの責任です。ROM の内容はこのブラウザー内に保存されます。',
